...
> If you want to better understand what this script is doing, checkout the [`form-script.js`](https://github.com/rishabh-stack/Html-form-to-google-sheets/blob/main/form-script.js) file in the repo for a detailed explanation. 
...
Please [create a new issue](https://github.com/rishabh-stack/form-to-google-sheet/issues). PRs are definitely welcome, but please run your ideas by me before putting in a lot of work. Thanks!
